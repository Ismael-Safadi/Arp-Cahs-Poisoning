...
sor = '\x00\x0C\x29\xa9\x34\x08'# attacker(kali)

victmac ='\x00\x0C\x29\x0F\x10\x4F' # parrot

gatemac = '\x00\x50\x56\xC0\x00\x08' # windows
...
psize = '\x04' 
opcode = '\x00\x02'
gate_ip = '192.168.78.1' 
victim_ip = '192.168.78.129' 
